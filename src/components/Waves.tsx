...
export const WaveBottom = () => (
  <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-0 translate-y-px pointer-events-none">
    <svg className="relative block w-[calc(100%+1.3px)] h-[35px] sm:h-[45px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 28" preserveAspectRatio="none" shapeRendering="auto">
      <defs>
        <path id="gentle-wave" d="M-160 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z" />
      </defs>
      <g className="wave-parallax">
        <use href="#gentle-wave" x="48" y="0" className="fill-slate-50/20" />
        <use href="#gentle-wave" x="48" y="3" className="fill-slate-50/40" />
        <use href="#gentle-wave" x="48" y="5" className="fill-slate-50/60" />
        <use href="#gentle-wave" x="48" y="7" className="fill-slate-50" />
      </g>
    </svg>
  </div>
);
...
export const WaveFooter = () => (
  <div className="absolute bottom-full left-0 w-full overflow-hidden leading-none z-10 translate-y-px pointer-events-none">
    <svg className="relative block w-[calc(100%+1.3px)] h-[40px] sm:h-[60px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 28" preserveAspectRatio="none" shapeRendering="auto">
      <defs>
        <path id="gentle-wave" d="M-160 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z" />
